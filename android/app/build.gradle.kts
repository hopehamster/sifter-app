...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            // for security reasons - this is just an example structure
    ...
    defaultConfig {
        // Updated application ID for production
        applicationId = "com.sifterapp.chat"
