...
# Direct BoringSSL-GRPC Fix for iOS
echo "======================================================================"
echo "            DIRECT BORINGSSL-GRPC FIX FOR iOS                         "
echo "======================================================================"
...
# Step 2: Update pub file to use compatible versions of packages
echo "[2/5] Updating Flutter dependencies to use compatible versions..."
cd ..
...
# Step 3: Create a modified Podfile with direct patching
echo "[3/5] Creating optimized Podfile with direct patching..."
cat > Podfile << 'EOL'
...
flutter run
EOL
chmod +x run_fixed_app.sh

echo ""
echo "======================================================================"
echo "                 DIRECT FIX HAS BEEN COMPLETED                      " 
echo "======================================================================"
echo ""
echo "To run the app with all fixes applied:"
echo "  ./run_fixed_app.sh"
echo ""
echo "This fix directly patches the BoringSSL code to remove format attributes"
echo "and uses build setting modifications to avoid -G flags."
echo ""
