...
# Create a fresh replacement file
cat > fixed_provider.h << 'EOF'
/*
...
# Replace the file 
cp fixed_provider.h "$AUTH_PROVIDER_PATH"
rm fixed_provider.h

echo "✅ Replaced FIRFederatedAuthProvider.h with fixed version" 